        ...
        function AppView(authenticationRepository) {
            ...
            menu.addMenuPanel(new crafity.html.MenuPanel("Onderhoud").addMenuItems([
                ...
                new crafity.html.MenuItem("Controles", function () {
                    if (controleView === null) {
                        controleView = new controles.views.UserView(controleRepository);
                    }
            ...
            controles.app.eventbus.on("openConstateringen", function (controle) {
                ...
                var ControleHeaderRepository = new controles.repositories.ControleHeaderRepository(
                    controle
                    , specialismsRepository.getSimpleSpecialismList()
                    , statusesRepository.getSpecialStatusList())

                    .on("stateChanged", function (data) {
                        ...
                        constateringenView = new controles.views.ConstateringenView(controle, constateringenRepository, specialistsRepository, ControleHeaderRepository);
